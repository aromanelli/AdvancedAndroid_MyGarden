...
public class PlantWateringService extends IntentService {
    ...
    final static public String ACTION_UPDATE_PLANT_WIDGETS =
            "com.example.android.mygarden.actino.update_plant_widgets";
    ...
    static public void startActionUpdatePlantWidgets(Context context) {
        Intent intent = new Intent(context, PlantWateringService.class);
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            // Determine correct plant image to show in widget ...
