...
public class PlantWidgetProvider extends AppWidgetProvider {
     ...
     */
    static private RemoteViews getGardenGridRemoteView(Context context) {
        ...
        // See GridWidgetService.getViewAt(int) for actual setting of template for plant
     ...
     */
    static private RemoteViews getSinglePlantRemoteView(Context context, int imgRes, long plantId, boolean showWater) {
