...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    // TODO (1a): Modify updateAppWidget method to take an image recourse
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // TODO (1b): and call setImageViewResource to update the widget’s image
        // Update grass image with plant most needing water image ...
    ...
    static public void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager, int imgRes, int[] appWidgetIds) {
