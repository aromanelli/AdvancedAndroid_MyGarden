...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        // TODO (3): Set the click handler to open the DetailActivity for plant ID, or the MainActivity if plant ID is invalid
        Intent intent;
    ...
    public static void updatePlantWidgets(
            Context context, AppWidgetManager appWidgetManager, int imgRes,
            int[] appWidgetIds, long plantId, boolean showWaterButton) {
